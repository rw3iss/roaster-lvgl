...
void lv_demo_test(void) {
    ...
    if (disp_size == DISP_LARGE) {
        ...
        lv_label_set_text(label, "Test demo");
        lv_obj_add_style(label, &style_text_muted, 0);
        lv_obj_align_to(label, logo, LV_ALIGN_OUT_RIGHT_BOTTOM, 10, 0);
    }

    lv_obj_t *t1 = lv_tabview_add_tab(tv, "Profile2");
    lv_obj_t *t2 = lv_tabview_add_tab(tv, "Analytics2");
    lv_obj_t *t3 = lv_tabview_add_tab(tv, "Shop2");
    profile_create(t1);
    analytics_create(t2);
    shop_create(t3);
...
static void profile_create(lv_obj_t *parent) {
    ...
    lv_label_set_text(name, "Ryan Weiss 2");
    ...
    lv_label_set_text(email_label, "rw3iss@gmail.com");
...
static lv_obj_t *create_meter_box(lv_obj_t *parent, const char *title, const char *text1, const char *text2,
    ...
    if (disp_size == DISP_MEDIUM) {
        static lv_coord_t grid_col_dsc[] = {LV_GRID_CONTENT, LV_GRID_FR(1), LV_GRID_CONTENT, LV_GRID_FR(8),
                                            LV_GRID_TEMPLATE_LAST};
        static lv_coord_t grid_row_dsc[] = {LV_GRID_CONTENT, LV_GRID_FR(1), LV_GRID_CONTENT,      LV_GRID_CONTENT,
